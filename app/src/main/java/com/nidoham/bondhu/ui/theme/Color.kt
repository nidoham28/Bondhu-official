...
val DarkColorScheme: ColorScheme = darkColorScheme(
    ...
    background          = AppColors.DarkBg,        // #1D2535
    onBackground        = AppColors.White,

    surface             = AppColors.DarkSurface,   // #252D3D
    onSurface           = AppColors.White,
    surfaceVariant      = AppColors.DarkSurfaceVariant, // #2D3545
...
val LightColorScheme: ColorScheme = lightColorScheme(
    ...
    onBackground        = Color(0xFF1D2535),

    surface             = AppColors.White,
    onSurface           = Color(0xFF1D2535),
    ...
    scrim               = Color(0xFF1D2535).copy(alpha = 0.32f)
)